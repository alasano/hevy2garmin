...
### Fixed
- "Lateral Raise (Dumbbell)" no longer shows in Garmin as "Leaning Dumbbell Lateral Raise". Fifteen exercises were mapped to a qualified variant although Garmin lists the plain exercise: Lateral Raise (Dumbbell), Chin Up (also assisted and weighted), Bicep Curl (Dumbbell), Shoulder Press (Dumbbell), Reverse Lunge (Dumbbell), Overhead Dumbbell Lunge, Dumbbell Snatch, Snatch, Split Jerk, Clean and Press, Box Jump, Jump Squat, Straight Leg Deadlift and Inverted Row. Lateral Raise (Band), Around The World, Clamshell and Ab Scissors now use their category alone, because their previous targets were a wrong exercise or a name Garmin Connect does not have. Every built-in target is now tested against Garmin Connect's own exercise list. Workouts that are already synced keep the old name until they are unsynced and synced again.
